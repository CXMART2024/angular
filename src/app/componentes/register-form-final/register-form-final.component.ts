...
export class RegisterFormFinalComponent implements OnInit {
  ...
  notificarEnvioSolicitud(solicitud: any) {
    ...
    this.http
      .post(
        'https://603b3a18bfeaef3c8fc4a002f51b5c.e1.environment.api.powerplatform.com:443/powerautomate/automations/direct/workflows/c892f3fc19c0414891f907ba67d85ad7/triggers/manual/paths/invoke?api-version=1&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=eFmFquQxFwg2A0ww6LybAoFc6cQ4VUU6_x5KWhuY6tM',
