...
import { contabilidadGuard } from './servicios/guard/contabilidad.guard';

const routes: Routes = [
  { path: '', component: LoginComponent },
  {
    path: 'informacion',
    component: InformacionBecaComponent,
    canActivate: [authGuard],
  },
  {
    path: 'informacion-view',
    component: InformacionBecaViewComponent,
    canActivate: [authGuard],
  },
  {
    path: 'detalle',
    component: DetalleAcademicoComponent,
    canActivate: [authGuard],
  },
  {
    path: 'addmodulo',
  ...
  {
    path: 'add-modulo-academico',
    component: NuevoCicloAcademicoComponent,
    canActivate: [authGuard],
  },
  {
    path: 'edit-modulo-academico',
    component: EditarCicloAcademicoComponent,
    canActivate: [authGuard],
  },
  {
    path: 'concepto-modulo-academico',
    component: ConceptoCicloAcademicoComponent,
    canActivate: [authGuard],
  },
  {
